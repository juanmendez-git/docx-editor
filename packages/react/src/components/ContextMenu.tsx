...
import type { AIAction, SelectionContext } from '@juanmendez90/docx-core/types/agentApi';
import { getActionDescription, DEFAULT_AI_ACTIONS } from '@juanmendez90/docx-core/types/agentApi';
