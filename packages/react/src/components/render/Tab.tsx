...
import type { TabStop, TabLeader, TabStopAlignment } from '@juanmendez90/docx-core/types/document';
import { twipsToPixels } from '@juanmendez90/docx-core/utils/units';
import {
  getNextTabStop,
  calculateTabWidth,
  getLeaderCharacter,
...
} from '@juanmendez90/docx-core/docx/tabParser';
