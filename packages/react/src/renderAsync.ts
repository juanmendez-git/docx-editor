 ...
 *
 * Returns an `EditorHandle` (from @juanmendez90/docx-core) that works with
 * any framework implementation.
 *
 * Usage:
 * ```ts
 * import { renderAsync } from '@juanmendez90/docx-js-editor';
 *
...
import type { Document } from '@juanmendez90/docx-core/types/document';
import type { EditorHandle } from '@juanmendez90/docx-core';
