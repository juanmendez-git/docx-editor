 ...
 * @example
 * ```ts
 * import { createMcpServer, startStdioServer } from '@juanmendez90/docx-core/mcp';
 * import { pluginRegistry, docxtemplaterPlugin } from '@juanmendez90/docx-core/core-plugins';
 *
 * // Register plugins
