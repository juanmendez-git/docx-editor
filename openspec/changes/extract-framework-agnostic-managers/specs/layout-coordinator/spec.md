...
The `LayoutCoordinator` class SHALL import only from `@juanmendez90/docx-core` internals and vanilla DOM APIs. It SHALL NOT import React, Vue, or any framework.
