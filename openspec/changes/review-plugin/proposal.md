...
Separate package (`@juanmendez90/docx-editor-agents`) under BSL-1.1 — source-available, free for non-production, paid subscription for commercial use.

## What Changes

- **New package** `packages/agent-use/` → `@juanmendez90/docx-editor-agents` (BSL-1.1)
...
- **Peer dependency**: `@juanmendez90/docx-core` — no code duplication
